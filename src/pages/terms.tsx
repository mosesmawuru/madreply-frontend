...
const Terms = () => {
  ...
  return (
    <Container>
      <Div p="20px 0" justifyContent="space-between">
        <LogoSection onClick={() => router.push("/")} />
      </Div>
      <Div mode="column" pt={30}>
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Country</strong> refers to: Northwest Territories, Canada
            </p>
          </li>
          <li>
            <p>
              ...
              in this Agreement) refers to Madreply.
            </p>
          </li>
          <li>
            <p>
        ...
        <p>
          ...
          our copyright agent via email at admin@madreply.com and include in
        ...
        <ul>
          <li>
            <p>By email: info@madreply.com</p>
          </li>
          <li>
            <p>
